...
const experiences = [
  {
    ...
    date: "October 2023",
    points: [
      "With my team I worked on simplifying the work of the logistic workers.",
      "They still do most of the job manually by hand which takes a lot of time.",
      ...
      "Which was connected to our C++ backend. IF we recieve throught our UI a part they want to move, and to which shelf,",
      "we automatically check if there is a spot on that shelf and if it's suitable for it or next possible and closest location",
      "which is returned as an output, where the user prompted to multiple choice, eg move the item and update it's position in the database.",
  ...
  },
  {
    ...
    points: [
      ...
      "push_swap: Wrote a simple sorting algorithm which is attempting to sort the numbers between two stack with the smallest amount of moves possible.",
      "pipex: I learned how child/parent processes are created via fork(). and how is the execution working inside of shell",
